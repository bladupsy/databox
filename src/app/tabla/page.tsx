...
const data = [
  ...
  { id: 10, cat: "finance", ind: "Tasa de Interés (TNA)", año: "2024", tipo: "Nominal %", val: "102%", src: "BCRA", obs: "Política monetaria contractiva." },
  { id: 11, cat: "finance", ind: "Tasa de Interés (TNA)", año: "2025", tipo: "Nominal %", val: "35%", src: "BCRA", obs: "Normalización financiera." },
  { id: 12, cat: "finance", ind: "Tasa de Interés (TNA)", año: "2026", tipo: "Nominal %", val: "27%", src: "BCRA", obs: "Fomento al crédito productivo." },
